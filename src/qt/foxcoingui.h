...
/**
  Foxcoin GUI main class. This class represents the main window of the Foxcoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class FoxcoinGUI : public QMainWindow
{
    Q_OBJECT
public:
    explicit FoxcoinGUI(QWidget *parent = 0);
    ~FoxcoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a Foxcoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
